...
import org.firstinspires.ftc.teamcode.drive.OdoLocalizerSirachaV1;
...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!(drive.getLocalizer() instanceof OdoLocalizerSirachaV1)) {
        ...
        telemetry.addLine("Effective LATERAL_DISTANCE: " +
                (headingAccumulator / (NUM_TURNS * Math.PI * 2)) * OdoLocalizerSirachaV1.LATERAL_DISTANCE);
