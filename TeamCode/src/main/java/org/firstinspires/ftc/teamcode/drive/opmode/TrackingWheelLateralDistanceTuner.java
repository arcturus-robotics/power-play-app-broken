...
import org.firstinspires.ftc.teamcode.drive.OdoLocalizerSirachaV2;
...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!(drive.getLocalizer() instanceof OdoLocalizerSirachaV2)) {
        ...
        telemetry.addLine("Effective LATERAL_DISTANCE: " +
                (headingAccumulator / (NUM_TURNS * Math.PI * 2)) * OdoLocalizerSirachaV2.LATERAL_DISTANCE);
